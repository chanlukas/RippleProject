function [False,VarName2,VarName3] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [FALSE,VARNAME2,VARNAME3] = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   [FALSE,VARNAME2,VARNAME3] = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [False,VarName2,VarName3] = importfile('test.txt',1, 27);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/20 17:08:17
